...
@media(max-width:600px){.stats-row{grid-template-columns:repeat(2,1fr)}.profile-top{flex-direction:column}.profile-icons{align-self:flex-end}.pill{padding:6px 12px;font-size:12px}.nav{padding:10px}}
`;